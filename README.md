...
This project began as a series of Claude.ai artifacts while I was learning about hex color codes and color theory, prior to moving into Github. The evolution is documented in `docs/prototypes/`:
